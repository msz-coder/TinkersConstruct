...
public final class MeleeHarvestToolStatsBuilder extends ToolStatsBuilder {
  ...
  public float buildDurability() {
    double averageHeadDurability = getAverageValue(heads, HeadMaterialStats::getDurability) + toolData.getStatOrDefault(ToolStats.DURABILITY, 0f);
  ...
  public float buildMiningSpeed() {
    double averageHeadSpeed = getAverageValue(heads, HeadMaterialStats::getMiningSpeed) + toolData.getStatOrDefault(ToolStats.MINING_SPEED, 0f);
  ...
  public float buildAttackDamage() {
    double averageHeadAttack = getAverageValue(heads, HeadMaterialStats::getAttack) + toolData.getStatOrDefault(ToolStats.ATTACK_DAMAGE, 0f);
